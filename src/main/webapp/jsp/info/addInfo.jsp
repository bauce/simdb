    ...
    <form class="layui-form" style="width: 90%" id="auf">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="saveInfo">临时保存</button>
                <button class="layui-btn" lay-submit="" lay-filter="submitInfo">保存并提交</button>
            </div>
        </div>

    </form>
    <script type="text/javascript" src="${ctx }/layui/layui.js"></script>
    <script type="text/javascript" src="${ctx }/js/info/addInfo.js"></script>
