...
<form class="layui-form" style="width: 94%;margin: 0px auto" id="auf">
    <input type="hidden" name="workId" class="workId"/>
    <div class="layui-form-item">
        <label class="layui-form-label">编号</label>
        <div class="layui-input-inline">
            <input type="text" name="no" class="layui-input no"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <select  id="dp" name="userId" lay-filter="dp" disabled="disabled" class="userId">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="content" class="layui-textarea content" placeholder="请输入工作内容"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="dueTime" class="layui-input dueTime" autocomplete="off"
                   placeholder="请选择报办结时限" style="display:none">
        ...
        <div class="layui-input-inline">
            <select name="finished" class="finished">
                <option value="" disabled selected hidden>是否办结</option>
...
<script type="text/javascript" src="${ctx }/js/work/editWork.js"></script>
</body>
</html>
